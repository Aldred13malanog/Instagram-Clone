...
import { videoFunction, checkPost, imageSlider, imgVidLike, bouncyEffect, viewCommentSection } from "./home-page-scripts.js";
...
function loadPage() {
	...
	document.querySelectorAll('.js-like-button').forEach((button, i) => {
		button.addEventListener('click', () => {
			...
			const likeCountElem = document.querySelector(`.js-like-counts-${i}`);
			...
			if (svg.ariaLabel === 'Like') {
				...
				count++;
				likeCountElem.innerHTML = `${count} likes`;
	...
	document.querySelectorAll('.js-comment-button').forEach((button, i) => {
		button.addEventListener('click', () => {
			viewCommentSection(button, i);
		});
	});
	// view all comments btn
	document.querySelectorAll('.js-viewall-comment-button').forEach((button, i) => {
		button.addEventListener('click', () => {
			viewCommentSection(button, i);
		});
	});
